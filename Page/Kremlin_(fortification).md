...
The word may share the same root as _kremen_ ( , "flint").[9] Some kremlins in Russia are called _detinets_, as for example the Novgorod Kremlin.
...
The same structure in Ukraine is called dytynets (, from _dytyna_ – child). The term has been in use since the 11th century. The term _kremlin_ first appeared in 14th century in Russian territories, where it replaced _dytynets_.
...
Category:Fortifications in Russia Kremlins
...
[6]  Origin and meaning of kremlin by Online Etymology Dictionary|website=www.etymonline.com|language=en|access-date=2018-09-26}}
