...
Texas_Hold'em_Poker_Table_with_Blinds.svg The primary advantage held by a player in late position is that he will have more information with which to make better decisions than players in early position, who will have to act first, without the benefit of this extra information. This advantage has led to many players in heads-up play raising on the button with an extremely wide range of hands because of this positional advantage.[3] Also, as earlier opponents fold, the probability of a hand being the best goes up as the number of opponents goes down.
...
-   Advice on Positional Play in Texas Holdem (including example hands)
