...
(at end of cable under plastic museum cover), cigarette lighter, and ash tray (left of the light gun).]]
...
with consoles and large display, which was projected from above. Archive photo taken during equipment installation.]]
...
shown on 3rd/4th floor wall) and COMMAND POST DIGITAL DISPLAY DESK[48] (center, with operators)]]
