...
The Hubble Space Telescope, in particular, has a highly developed series of steps (“data reduction pipeline”) to convert the raw CCD data to useful images.[21]
...
In addition to imagers, CCDs are also used in an array of analytical instrumentation including spectrometers[22] and interferometers.F. J. Duarte, On a generalized interference equation and interferometric measurements, _Opt. Commun._ 103,
...
Category:American inventions Category:Integrated circuits Category:Image processing Category:Image sensors Category:Image scanners Category:Astronomical imaging
...
[22] V. Deckert and W. Kiefer, Scanning multichannel technique for improved spectrochemical measurements with a CCD camera and its application to Raman spectroscopy, _Appl. Spectros._ 46, 322-328 (1992)

[23] Phil Plait. "The Planet X Saga: SOHO Images"

[24] Phil Plait. "Why, King Triton, how nice to see you!"

[25] Thomas J. Fellers and Michael W. Davidson. "CCD Saturation and Blooming"
