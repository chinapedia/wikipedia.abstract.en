...
1.  While a record is playing, start a second record playing, but only monitored through headphones, not being fed to the main PA system. Use gain (or _trim_) control on the mixer to match the levels of the two records.
...
Category:DJing Category:Disco Category:Audio mixing
