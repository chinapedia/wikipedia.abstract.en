...
Although libraries created order within their collections from as early as the fifth century BC,[7] the Paris Bookseller's classification, developed in 1842 by Jacques Charles Brunet, is generally seen as the first of the modern book classifications. Brunet provided five major classes: theology, jurisprudence, sciences and arts, belles-lettres, and history.[8]
...
Universal schemes: Covers all subjects, e.g. the Dewey Decimal Classification, Universal Decimal Classification and Library of Congress Classification.
Specific classification schemes: Covers particular subjects or types of materials, e.g. Iconclass, British Catalogue of Music Classification, and Dickinson classification, or the NLM Classification.
National schemes: Specially created for certain countries, e.g. the Swedish library classification system, SAB (Sveriges Allmänna Biblioteksförening).
...
Faceted/analytico-synthetic: Subjects are divided into mutually exclusive orthogonal facets.
...
-   V-LIB 1.3 (2018 Vartavan Library Classification for over 700 fields of knowledge, based on the V-FRAME (http://projectis.co.uk/v-frame) and currently sold under license in the UK by PROJECTIS CONSULTANTS Ltd (http://projectis.co.uk/v-lib)
-   London Education Classification used at the UCL Institute of Education
-   Garside Classification Scheme used in most libraries of University College London[9]
...
Classification systems in libraries generally play two roles. Firstly, they facilitate subject access by allowing the user to find out what works or documents the library has on a certain subject.[10] Secondly, they provide a known location for the information source to be located (e.g. where it is shelved).
...
Library_cataloging_and_classification Category:Knowledge representation
...
[9] https://www.ucl.ac.uk/library/subject-support/garside-classification-scheme

[10]

[11] Lynch, Sarah N., and Eugene Mulero. "Dewey? At This Library With a Very Different Outlook, They Don't" _The New York Times_, July 14, 2007.