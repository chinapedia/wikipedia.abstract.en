...
An urban bus in Nicaragua takes the same road multiple times per day, following a more or less strict schedule. The organization of the buses in different towns differs heavily as every town is organizing it on their own behave. In Estelí every bus driver is assisted by mostly two persons helping them (_Ayudantes_). Bus drivers in Managua have to manage their job on their own.[4]
...
To improve the accessibility of public transport, in 2016 the OpenStreetMap group in Nicaragua MapaNica crowdsourced with the help of more than 150 citizens of Managua the first bus transit map in whole Central America.[7] Later in 2018, they made this data machine-accessible, serving it today in different apps on several platforms.[8]

Urban buses in Managua will be use electric bus, hybrid-electric bus and dual-mode bus that are currently in operational test.

Suburban buses

Suburban buses (_Suburbanos_) connect larger cities with communities in outer areas. They only stop a few times inside the city, later nearly everywhere where passengers request to get off. Like with urban buses, a team serves a route several times per day and the service is organized by the local government. Prices can vary depending on the distance.[9]
...
As of 2013, 147 airports exist in Nicaragua.[13] Nicaragua's main international airport is Managua International Airport.

Airports - with paved runways

In total, there are 12 airports with paved runways with the following lengths:[14]

-   _2,438 to 3,047 m:_ 3
...
In total, there are 135 airports with unpaved runways with the following lengths:[15]

-   _1,524 to 2,437 m:_ 1
-   _914 to 1,523 m:_ 15
-   _under 914 m:_ 119


Water transport

Nicaragua offers 2,220 km of water transport roads, including the two large lakes Lake Nicaragua and Lake Managua. A Nicaragua Canal was planned but canceled on 21 February 2018.[16][17][18]
...
-   German article "Yesterday and Today: Public Transport in Nicaragua"
