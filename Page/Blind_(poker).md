...
After the cards are dealt, the player to the left of the big blind is the first to act during the first betting round. If any players call the big blind, the big blind is then given an extra opportunity to raise. This is known as a _live blind_. If the live blind checks, the betting round then ends.
