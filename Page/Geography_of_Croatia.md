...
national park|alt=Coastline with rocky shore]] Croatia's Adriatic Sea mainland coast is long, while its 1,246 islands and islets have a further of coastline. The distance between the extreme points of Croatia's coastline is . The number of islands includes all islands, islets, and rocks of all sizes, including ones emerging only at low tide.[39] The largest islands in the Adriatic are Cres and Krk, each covering ; the tallest is Brač, reaching above sea level. The islands include 47 permanently inhabited ones, the most populous among them being Krk and Korčula.[40]
...
Karst topography makes up about half of Croatia and is especially prominent in the Dinaric Alps.[51] There are numerous caves in Croatia, 49 of which are deeper than , 14 deeper than and 3 deeper than .[52] The longest cave in Croatia, Kita Gaćešina, is at the same time the longest cave in the Dinaric Alps at .[53] seen from Knin|alt=Picture of large mountain with about 30-degree sloped sides]]
...
, a UNESCO World Heritage Site|alt=Two greenish-blue lakes in a forest]]
