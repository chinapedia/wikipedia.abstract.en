...
-   p_(t) is the stagnation or total pressure;
-   p_(s) is the static pressure;
...
If a liquid column manometer is used to measure the pressure difference Δp ≡ p_(t) − p_(s),

$$\Delta h = \frac{\Delta p}{\rho_l g} \,,$$
where

-   Δh is the height difference of the columns;
-   ρ_(l) is the density of the liquid in the manometer;
...
Category:Flow meters Category:Aircraft instruments Category:Speed sensors Category:Measuring instruments Category:French inventions

[1]

[2]

[3] "How Aircraft Instruments Work." _Popular Science_, March 1944, pp. 116.
