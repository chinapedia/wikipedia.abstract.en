...
-   Vehicles under 50cc (e.g. mopeds, tractors)
-   Animals
...
-   BOATLE INTERCHANGE in BOATLE, its map plan (phase one) it's done, and the tendering of the project, it's done (phase two) and the groundbreaking or construction (phase three) has commenced.

PROPOSED

The Government of Botswana is committed to build three (3) interchanges along K.T MOTSETE DRIVE (_WESTERN BYPASS_) in Gaborone.
...
[2] Passenger train is coming back, Tue 09 Dec 2014, Mmegi Online, http://www.mmegi.bw/index.php?aid=47955
