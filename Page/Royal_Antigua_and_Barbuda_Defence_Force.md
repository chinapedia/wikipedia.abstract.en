...
-   Coast Guard — the maritime element of the defence force, and is divided into four units:
    ...
    -   Flotilla — the flotilla is the operational part of the Coast Guard, and consists of the following water-craft:
        -   1 Swiftships Shipbuilders 19.81-metre Commercial Cruiser-class patrol boat (P-01 _Liberta_), in service since 1984[1]
        -   1 SeaArk Boats Dauntless-class patrol boat (P-02 _Palmetto_), in service since 1995[2]
        -   1 Point-class cutter (P-03 _Hermitage_), transferred from the U.S. Coast Guard in 1998[3]
        -   1 Defender 380X-class all-weather interceptor (D-8), date of acquisition unknown[4]
        -   2 Boston Whaler 8.23-metre launches (071 and 072), in service since 1988[5]
        -   1 Zodiac Marine & Pool 8.23-metre Hurricane-type rigid-hulled inflatable boat (RHIB) in service since 1998[6]
-   Antigua and Barbuda Cadet Corps


Former deployments

-   In 1983, fourteen men of the _Antigua and Barbuda Defence Force_ were deployed to Grenada during the Operation Urgent Fury.[7]
...
-   In 1995, members of the _Antigua and Barbuda Defence Force_ were deployed in Haiti as a part of Operation Uphold Democracy.[8]
...
Military_of_Antigua_and_Barbuda Category:Military units and formations established in 1981
