...
Unlike most later consoles, the Microvision did not contain an onboard processor (CPU). Instead, each game included its own processor contained within the removable cartridge.[5][6][7] This meant that the console itself effectively consisted of the controls, LCD panel and LCD controller.[8][9]
...
-   Launch titles - 1979
    -   _Block Buster_ - _Breakout_ clone that shipped with the system.
    -   _Bowling_
    -   _Connect Four_
    -   _Pinball_
-   1979
    -   _Mindbuster_
    -   _Star Trek: Phaser Strike_ (later just _Phaser Strike_; sold in Germany, Italy and the UK as _Shooting Star_, and France as _Cannon Phaser_[11])
    -   _Vegas Slots_
-   1980
    -   _Baseball_
    -   _Sea Duel_ (sold in Germany as _See-Duell_)
-   1981
    -   _Alien Raiders_
    -   _Cosmic Hunter_
-   1982
    -   _Super Blockbuster_ (Released only in Europe)
-   Unreleased
    -   _Barrage_ (should be released in 1982)
...
Category:Handheld game consoles Category:Monochrome video game consoles Category:Products introduced in 1979 Category:1980s toys Category:Milton Bradley Company games Category:Microvision Category:Discontinued handheld game consoles

[1]

[2]

[3] A Brief History of Handheld Video Games
