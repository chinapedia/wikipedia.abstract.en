...
Originally referred to as the PC/AT-bus, it was also termed _I/O Channel_ by IBM. The ISA term was coined as a retronym by competing PC-clone manufacturers in the late 1980s or early 1990s as a reaction to IBM attempts to replace the AT-bus with its new and incompatible Micro Channel architecture.
...
ISA is still used today for specialized industrial purposes. In 2008 IEI Technologies released a modern motherboard for Intel Core 2 Duo processors which, in addition to other special I/O features, is equipped with two ISA slots. It is marketed to industrial and military users who have invested in expensive specialized ISA bus adaptors, which are not available in PCI bus versions.[4]

Similarly, ADEK Industrial Computers is releasing a motherboard in early 2013 for Intel Core i3/i5/i7 processors, which contains one (non-DMA) ISA slot.[5]
...
IEEE started a standardization of the ISA bus in 1985, called the P996 specification. However, despite there even having been books published on the P996 specification, it never officially progressed past draft status.[6]


Modern ISA cards

There still is an existing user base with old computers, so some ISA cards are still manufactured, e.g. with USB ports[7] or complete single board computers based on modern processors, USB 3.0, and SATA.[8]


See also

-   PC/104 - Embedded variant of ISA
-   Low Pin Count (LPC) - Low pin count version of ISA
...
-   _Intel ISA Bus Specification and Application Notes - Rev 2.01_; Intel; 73 pages; 1989.
...
Category:Computer buses Category:Motherboard expansion slot Category:IBM personal computers Category:IBM PC compatibles Category:Legacy hardware
...
[4] IEI Technology Corp: _IMBA-9654ISA User Manual_, Rev. 1.00, May 2008

[5] ADEK Industrial Computers: _MS-98A9 Product Specifications_
