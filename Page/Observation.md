...
An observational bias occurs when researchers only look where they think they will find positive results, or where it is easy to record observations. This is called the "streetlight effect".[8]
...
For example, let us suppose that an observer _sees_ a parent beat their child; and consequently may observe that such an action is either good or bad. Deductions about what behaviors are good or bad may be based on preferences about building relationships, or study of the consequences resulting from the observed behavior. With the passage of time, impressions stored in the consciousness about many, together with the resulting relationships and consequences, permit the individual to build a construct about the moral implications of behavior.
...
Category:Aptitude Category:Cognition Category:Epistemology of science Observation Category:Philosophy of science Category:Sources of knowledge Category:Perception Category:Experiments Category:Scientific method Category:Assumption
