...
|                        | notation     | notation | term                        |
+========================+==============+==========+=============================+
|                        |              |          |                             |
+------------------------+--------------+----------+-----------------------------+
|                        |              |          |                             |
+------------------------+--------------+----------+-----------------------------+
| Negation               | ¬φ           | Nφ       | _negacja_                   |
+------------------------+--------------+----------+-----------------------------+
| Conjunction            | φ ∧ ψ        | Kφψ      | _koniunkcja_                |
+------------------------+--------------+----------+-----------------------------+
| Disjunction            | φ ∨ ψ        | Aφψ      | _alternatywa_               |
+------------------------+--------------+----------+-----------------------------+
| Material conditional   | φ → ψ        | Cφψ      | _implikacja_                |
+------------------------+--------------+----------+-----------------------------+
| Biconditional          | φ ↔ ψ        | Eφψ      | _ekwiwalencja_              |
+------------------------+--------------+----------+-----------------------------+
| Falsum                 | ⊥            | O        | _fałsz_                     |
+------------------------+--------------+----------+-----------------------------+
| Sheffer stroke         | φ ∣ ψ        | Dφψ      | _dysjunkcja_                |
+------------------------+--------------+----------+-----------------------------+
| Possibility            | ◇φ           | Mφ       | _możliwość_                 |
+------------------------+--------------+----------+-----------------------------+
| Necessity              | □φ           | Lφ       | _konieczność_               |
+------------------------+--------------+----------+-----------------------------+
| Universal quantifier   | ∀p φ         | Πp φ     | _kwantyfikator ogólny_      |
+------------------------+--------------+----------+-----------------------------+
| Existential quantifier | ∃p φ         | Σp φ     | _kwantyfikator szczegółowy_ |
+------------------------+--------------+----------+-----------------------------+
...
-   -   Translated by H. Weber in Storrs McCall, _Polish Logic 1920-1939_, Clarendon Press: Oxford (1967).
