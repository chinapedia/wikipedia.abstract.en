...
In 2006 StopBadware.org identified Kazaa as a spyware application.[16] They identified the following components:
...
-   NEW.NET (hijacker): A browser plugin that lets you access several of its own unofficial Top Level Domain names, e.g., .chat and .shop. The main purpose of this was to sell domain names such as www.record.shop which is actually www.record.shop.new.net.


Transitional period

Kazaa's legal issues ended after a settlement of $100 million in reparations to the recording industry.[17] Kazaa, including the domain name, was then sold off to Brilliant Digital Entertainment, Inc. Kazaa then operated as a monthly music subscription service allowing users to download unlimited songs, before finally ending the service.
...
Without further recourse, and until the lawsuit was settled, the RIAA actively sued thousands of people and college campuses across the U.S. for sharing copyrighted music over the network.[18] Particularly, students were targeted and most were threatened with a penalty of $750 per song.[19] Although the lawsuits were mainly in the U.S., other countries also began to follow suit.[20] Beginning in 2008, however, RIAA announced an end to individual lawsuits.[21]

Napster was able to outlast Kazaa as the former never really took off and only lasted a few years.[22] By 2012, Kazaa's website was inactive, displaying the message "We thank you for your interest in Kazaa. However we no longer offer a music service."; by 2017 kazaa.com no longer existed.


Variations

KAZAA LITE was an unauthorized modification of the Kazaa Media Desktop application which excluded adware and spyware and provided slightly extended functionality. It became available in April 2002. It was available free of charge, and as of mid-2005 was almost as widely used as the official Kazaa client itself. It connected to the same FastTrack network and thus allowed to exchange files with all Kazaa users, and was created by third party programmers by modifying the binary of the original Kazaa application.[23] Later versions of Kazaa Lite included K++, a memory patcher that removed search limit restrictions, and set one's "participation level" to the maximum of 1000. Sharman Networks considers Kazaa Lite to be a copyright violation.
...
Category:2001 software Category:Adware Category:Discontinued software Category:Estonian inventions Category:File sharing software Category:Internet services shut down by a legal challenge Category:Music retailers of the United States Category:Online music database clients Category:Online music stores Category:United States Internet case law Category:Windows file sharing software Category:Peer-to-peer software
...
[5] MGM Studios, Inc. v. Grokster, Ltd. at Wikisource
...
[14] Title 17 USC § 504 Statutory Damages
