...
Apicomplexa_structure.svg Ookinete,_sporozoite,_merozoite.png
...
Septate_gregarine.jpg The gregarines are generally parasites of annelids, arthropods, and mollusks. They are often found in the guts of their hosts, but may invade the other tissues. In the typical gregarine lifecycle, a trophozoite develops within a host cell into a schizont. This then divides into a number of merozoites by schizogony. The merozoites are released by lysing the host cell, which in turn invade other cells. At some point in the apicomplexan lifecycle, gametocytes are formed. These are released by lysis of the host cells, which group together. Each gametocyte forms multiple gametes. The gametes fuse with another to form oocysts. The oocysts leave the host to be taken up by a new host.

Coccidians

Toxoplasma_gondii.jpg'' (Coccidia) parasites]] In general, coccidians are parasites of vertebrates. Like gregarines, they are commonly parasites of the epithelial cells of the gut, but may infect other tissues.
...
Apicomplexa_tree..png This scheme is taken from Perkins et al.[40] It is outdated as the Perkinsidae have since been recognised as a sister group to the dinoflagellates rather that the Apicomplexia. The remainder of the scheme appears to be valid:
