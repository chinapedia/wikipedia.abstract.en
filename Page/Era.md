...
Comparable terms are epoch, age, period, saeculum, aeon (Greek _aion_) and Sanskrit yuga.


Etymology

The word has been in use in English since 1615, and is derived from Late Latin _aera_ "an era or epoch from which time is reckoned," probably identical to Latin _æra_ "counters used for calculation," plural of _æs_ "brass, money".

The Latin word use in chronology seems to have begun in 5th century Visigothic Spain, where it appears in the _History_ of Isidore of Seville, and in later texts. The Spanish era is calculated from 38 BC, perhaps because of a tax (cfr. indiction) levied in that year, or due to a miscalculation of the Battle of Actium, which occurred in 31 BC.
...
For a time ranging from 1872 to the Second World War, the Japanese used the imperial year system (_kōki_), counting from the year when the legendary Emperor Jimmu founded Japan which occurred in 660 BC.
...
Other calendar eras of the past counted from political events, such as the Seleucid era and the Ancient Roman _ab urbe condita_ ("AUC"), counting from the foundation of the city.
...
Category:Chronology Category:Units of time

[1] Short, N.M. (2009). "Geologic Time" in _Remote Sensing Tutorial_ . NASA.

[2] Lide, D. R. (1990). _Handbook of Chemistry and Physics_. Boca Raton: CRC Press. pp. 14-16.
