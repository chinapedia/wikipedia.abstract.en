...
Its origins can be traced back to Michigan Lake in the 1960s where a game called Cosom Hockey was developed, although the present type of floorball was invented in Sweden in the 1970s.[1] Floorball is most popular where it has been developed the longest, such as the Czech Republic, Denmark, Estonia, Finland, Latvia, Norway, Sweden, and Switzerland. It is gaining popularity in Australia, New Zealand, India,[2] Canada,[3] Germany,[4] Ireland,[5] Japan,[6] Singapore,[7] Malaysia,[8] the United States.[9] and the United Kingdom.[10]

As of 2014, there are over 300,133 registered floorball players worldwide.[11] Professional leagues include Finland's Salibandyliiga and Sweden's Svenska Superligan.
...
A floorball game is officially played over three periods lasting 20 minutes each (15 minutes for juniors). The time is stopped in the case of penalties, goals, time-outs and any situation where the ball is not considered to be in play. The signal of a timeout should be a triple sound.[28] An intermission of 10 minutes (or maximum 15 minutes in some competitions)[29] takes place between each period, where teams change ends and substitution areas. Each team is allowed one timeout of 30 seconds (which is often used late in matches). There are two referees to oversee the game, each with equal authority. If a game ends in a tie, teams play ten minutes extra, and the team that scores first wins.[30]. If the game is still drawn after extra-time, a penalty shootout similar to ice-hockey decides over the winner.
...
In 2011, the winners were Men: SSV Helsinki (Finland) and Women: IF Djurgårdens IBF (Sweden).[34]
...
The winner of the EFC qualifies to play in the Champions Cup the following year. The reigning EuroFloorball Cup Champions as of October 2011, are Men: RTU/Inspecta (Latvia)and Women: RSU/Runway (Latvia).[35]
...
Floorball Category:Team sports Category:Mixed-sex sports Category:Indoor sports Category:Ball games Category:Variations of hockey Category:Sports originating in Sweden

[1]  IWGA|website=www.theworldgames.org|access-date=2018-04-22}}
