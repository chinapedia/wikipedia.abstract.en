...
-   In video games
    ...
    -   To distinguish friend from foe, for instance in _StarCraft_, _Halo_, or _League of Legends_
    -   To distinguish rarity or quality of items in adventure and role-playing games[5]
-   In navigation:
    -   Navigation light
    -   Sea mark
...
-   In social functions:
    ...
    -   Handkerchief code
    -   Ribbon colors _see:_ :Category:Ribbon symbolism
    -   Rank in Judo
...
Color_codes Category:Encodings

[1] _Transactions of the American Society of Civil Engineers: Volume 29_ (1893), p. 507.

[2] See, e.g., Michael Richard Cohen, _Medication Errors_ (2007), p. 119.
