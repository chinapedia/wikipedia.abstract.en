...
The family name Tettigoniidae is derived from the genus _Tettigonia_, first described by Carl Linnaeus in 1758. In Latin _tettigonia_ means leafhopper; it is from the Greek _tettigonion_, the diminutive of the imitative (onomatopoeic) τέττιξ, _tettix_, cicada.[5] All of these names such as _tettix_ with repeated sounds are onomatopoeic, imitating the stridulation of these insects.[6] The common name _katydid_ is also onomatopoeic and comes from the particularly loud, three-pulsed song, often rendered "_ka-ty-did_", of the nominate subspecies of the North American _Pterophylla camellifolia_, whose most common English name is the common true katydid.[7][8]
...
Some species of bush crickets are consumed by people, such as the _nsenene_ (_Ruspolia baileyi_) in Uganda and neighbouring areas.

Communication

The males of tettigoniids have sound-producing organs located on the hind angles of their front wings. In some species, females are also capable of stridulation. Females chirp in response to the shrill of the males. The males use this sound for courtship, which occurs late in the summer.[22] The sound is produced by rubbing two parts of their bodies together, called stridulation. One is the file or comb that has tough ridges; the other is the plectrum is used to produce the vibration.[23] For tettigoniids, the fore wings are used to sing. Tettigoniids produce continuous songs known as trills. The size of the insect, the spacing of the ridges, and the width of the scraper all influence what sound is made.[24]

Many katydids stridulate at a tempo which is governed by ambient temperature, so that the number of chirps in a defined period of time can produce a fairly accurate temperature reading. For American katydids, the formula is generally given as the number of chirps in 15 seconds plus 37 to give the temperature in degrees Fahrenheit.[25]
...
* Category:Orthoptera families Category:Extant Jurassic first appearances Category:Taxa named by Hermann August Krauss
...
[16] Orthoptera species file (retrieved 3 January 2018)

[17] GBIF: _Triassophyllum_ Papier et al., 1997 (retrieved January 2018))
