...
The Mk.I was the original Ford GT40. Early prototypes were powered by alloy V8 engines [12] and production models were powered by {{cvt as used in the Ford Mustang. Five prototype models were built with roadster bodywork, including the Ford X-1.[13] Two lightweight cars (of a planned five) were built by Alan Mann Racing in 1966, with light alloy bodies and other weight-saving modifications.
