...
In 1868 Montreal Telegraph began facing competition from the newly established Dominion Telegraph Company.[3] 1880 saw the Great North Western Telegraph Company established to connect Ontario and Manitoba but within a year it was taken over by Western Union, leading briefly to that company's control of almost all telegraphy in Canada.[4] In 1882, Canadian Pacific transmitted its first commercial telegram over telegraph lines they had erected alongside its tracks,[5] breaking Western Union's monopoly. Great North Western Telegraph, facing bankruptcy, was taken over in 1915 by Canadian Northern.[6]

By the end of World War II, Canadians communicated by telephone, more than any other country.[7] In 1967 the CP and CN networks were merged to form CNCP Telecommunications.

As of 1951, approximately 7000 messages were sent daily from the United States to Canada.[8] An agreement with Western Union required that U.S. company to route messages in a specified ratio of 3:1, with three telegraphic messages transmitted to Canadian National for every message transmitted to Canadian Pacific.[9] The agreement was complicated by the fact that some Canadian destinations were served by only one of the two networks.[10]
...
As of 2016, there were over 1,100 radio stations and audio services broadcasting in Canada.[11] Of these, 711 are private commercial radio stations. These commercial stations account for over three quarters of radio stations in Canada. The remainder of the radio stations are a mix of public broadcasters, such as CBC Radio, as well as campus, community, and Aboriginal stations.[12]


Television

As of 2016, 780 TV services were broadcasting in Canada.[13]
...
Bell, Rogers, Telus, and Shaw are among the bigger ISPs in Canada. Depending on your location, Bell and Rogers would be the big internet service providers in Ontario, while Shaw and Telus are the main players competing in western provinces.[14]

-   Internet service providers: there are more than 44 ISPs in Canada, including Beanfield, Bell Canada, Cable Axion, Cablevision (Canada), Chebucto Community Net, Cogeco, Colbanet, Craig Wireless, Dery Telecom, Eastlink (company), Electronic Box, Everus Communications, Guest-tek, Information Gateway Services, Internex Online, Inukshuk Wireless, Jet2.net, Look Communications, Managed Network Systems, Inc., Mountain Cablevision, National Capital FreeNet, Novus Entertainment, Ontera, Persona Communications, Primus Canada, Project Chapleau, Qiniq, Rogers Hi-Speed Internet, Rose Media, Rush Communications Ltd., SaskTel, Seaside Communications, Source Cable, SSI Micro, TAO (collective), TekSavvy, Telus, Telus Internet, Vidéotron, Vmedia, Web Community Resource Networks, Wireless Nomad, YourLink[15]
-   Internet Exchange Points: There are multiple Internet Exchange Points in Canada, the largest of which are in Toronto, Montreal, Vancouver and Calgary. Most ISP's peer at one or more of these Exchanges, except for Bell Canada. The Toronto Internet Exchange ranks as one of the largest in the world.[16]
-   Country codes: .CA, CDN, 124
-   Internet users: 33 million users [17]
-   Internet hosts: 8.7 million (2012-2017)[18]
-   Percentage of households with Internet access: 87(2016)[19]
-   Total households with high speed connection: 67% (2014)[20]
-   Total users of home online banking: 68% (2016)[21]


Mobile networks

The three major mobile network operators are Rogers Wireless (10.6 million subscribers), Bell Mobility (9.0 million) and Telus Mobility (8.8 million), which have a combined 91% of market share.[22]
...
Communications_in_Canada Category:Telecommunications in Canada Canada Canada
...
[22] Number of mobile phone network subscribers 2017 Q3 - CWTA