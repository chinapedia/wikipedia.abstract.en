...
The name "Konqueror" echoes a colonization paradigm to reference the two primary competitors at the time of the browser's first release: "first comes the Navigator, then Explorer, and then the Konqueror".[1] It also follows the KDE naming convention: the names of most KDE programs begin with the letter K.[2]

Konqueror first appeared with version 2 of KDE on October 23, 2000.[3] It replaces its predecessor, KFM (KDE file manager).[4] With the release of KDE 4, Dolphin replaced Konqueror as the default KDE file-manager, but the KDE community continues to maintain Konqueror as the default KDE web-browser.
...
Kubuntu's 10.10 Maverick Meerkat release switched their default browser from Konqueror to rekonq.[6] However, Kubuntu has since switched from rekonq to Firefox, with the release of 14.04 Trusty Tahr.[7]
...
KGET is a free download manager for KDE and is the default download manager for Konqueror. It is part of the KDE Network package. By default it is the download manager used for Konqueror, but can also be used with Mozilla Firefox[8] and rekonq. KGet was featured by _Tux Magazine_[9] and _Free Software Magazine_.[10]

History

On KDE 3, KGet 0.8.x, 1 supported HTTP/FTP download.[11] On KDE Software Compilation 4, KGet 2 was released; it supported bandwidth throttling segmentation, multi-threading, and the BitTorrent protocol.[12]
...
-   Download from multiple servers to speed up download time (segmented file transfer).[13][14]
...
Category:1996 software Category:Applications using D-Bus Category:Cross-platform web browsers Category:Free file managers Category:Free web browsers Category:KDE Applications Category:POSIX web browsers Category:Software using the GPL license Category:Web browsers that use Qt

[1] Compare:

[2] K Desktop Environment (KDE)

[3] K Desktop Environment - KDE 2.0 Release Announcement

[4] Konqueror - Konqueror FAQ
