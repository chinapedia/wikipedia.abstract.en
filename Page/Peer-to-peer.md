P2P-network.svg Server-based-network.svg''', where individual _clients_ request services and resources from centralized servers]]
...
Unstructured_peer-to-peer_network_diagram.png _Unstructured peer-to-peer networks_ do not impose a particular structure on the overlay network by design, but rather are formed by nodes that randomly form connections to each other.[16] (Gnutella, Gossip, and Kazaa are examples of unstructured P2P protocols).[17]
...
Structured_(DHT)_peer-to-peer_network_diagram.png (DHT) to identify and locate nodes/resources]]
...
Torrent_peers.png connect peers]]
