...
Amfm3-en-de.gif using AM or FM methods.|alt=Animation of audio, AM and FM modulated carriers.]]
...
Telefunken_arc_radiotelephone.jpg from 1906. The carrier wave is generated by 6 electric arcs in the vertical tubes, connected to a tuned circuit. Modulation is done by the large carbon microphone _(cone shape)_ in the antenna lead. ]] Meissner_radiotelephone_transmitter.jpg AM radio transmitters, built by Meissner in 1913 with an early triode tube by Robert von Lieben. He used it in a historic 36 km (24 mi) voice transmission from Berlin to Nauen, Germany. Compare its small size with above transmitter. ]]
...
Illustration_of_Amplitude_Modulation.png Consider a carrier wave (sine wave) of frequency _f_(c)_ and amplitude _A_ given by:
...
Amplitude_Modulated_Wave-hm-64.svg
