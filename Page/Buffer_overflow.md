...
Buffer overflow protection is used to detect the most common buffer overflows by checking that the stack has not been altered when a function returns. If it has been altered, the program exits with a segmentation fault. Three such systems are Libsafe,[23] and the _StackGuard_[24] and _ProPolice_[25] gcc patches.
...
-   Chapter 12: Writing Exploits III from _Sockets, Shellcode, Porting & Coding: Reverse Engineering Exploits and Tool Coding for Security Professionals_ by James C. Foster (). Detailed explanation of how to use Metasploit to develop a buffer overflow exploit from scratch.
...
Category:Software bugs Category:Computer memory Category:Computer security exploits
...
[17] http://wiretap.area.com/Gopher/Library/Techdoc/Virus/inetvir.823
