...
EXAPT is a modularly built programming system for all NC machining operations [1] as
...
With the foundation of the EXAPT-Verein in 1967 as spin-off of the universities Aachen, Berlin and Stuttgart the further development „EXAPT (EXtended Subset of APT)“ of the programming language „APT (Automatically Programmed Tool)“ was focused and so the first milestone for the EXAPT history was set.[2] In the same year the system EXAPT 1 for drilling and simple milling tasks is available.
...
-   Official website of EXAPT Systemtechnik GmbH

Category:Application software Category:Computer-aided design software Category:Computer-aided manufacturing software Category:Planning Category:Industrial machinery Category:Programming languages
