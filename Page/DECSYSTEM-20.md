...
PDP-10 computers running the TOPS-10 operating system were labeled _DECsystem-10_ as a way of differentiating them from the PDP-11. Later on, those systems running TOPS-20 (on the KL10 PDP-10 processors) were labeled _DECSYSTEM-20_ (the block capitals being the result of a lawsuit brought against DEC by Singer, which once made a computer called "system-10"). The DECSYSTEM-20 was sometimes called PDP-20, although this designation was never used by DEC.
...
The only significant difference the user could see between a DECsystem-10 and a DECSYSTEM-20 was the operating system and the color of the paint. Most (but not all) machines sold to run TOPS-10 were painted "Blasi Blue",[1] whereas most TOPS-20 machines were painted "Terracotta" (often mistakenly called "Chinese Red" or orange; the actual name of the color on the paint cans was Terracotta[2]).
...
-   -   C. Gordon Bell, Alan Kotok, Thomas N. Hasting, Richard Hill, "The Evolution of the DECsystem-10", in C. Gordon Bell, J. Craig Mudge, John E. McNamara, _Computer Engineering: A DEC View of Hardware Systems Design_ (Digital Equipment, Bedford, 1979)
-   Frank da Cruz, Christine Gianone, The DECSYSTEM-20 at Columbia University 1977–1988


Further reading

-   _Storage Organization and Management in TENEX_. Daniel L. Murphy. AFIPS Proceedings, 1972 FJCC.
...
Category:36-bit computers Category:DEC hardware Category:DEC mainframe computers Category:Computer-related introductions in 1977

[1] System Paint, Digital Equipment Corporation, 1998
