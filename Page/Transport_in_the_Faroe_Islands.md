...
_total:_ [8]
    ...
    _national highways:_ [9]
    _local roads:_ [10]

Bus services

There is an extensive bus network, with red and yellow _Bussleiðin_ town buses serving Tórshavn and Klaksvík respectively, and blue _Bygdaleiðir_ (which means "village route") buses connecting the rest of the islands. Most buses are modern and were built by the Volvo company.
...
_total:_ 6 ships ( or over) totaling / (1999 est.)
...
Transport_in_the_Faroe_Islands Faroe Islands Category:Tourism in the Faroe Islands
...
[6] Aktuelt.fo, Tunnilin skal upp bæði á Strondum og í Runavík
