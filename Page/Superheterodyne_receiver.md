...
Prototype_Armstrong_superheterodyne_receiver_1920.jpg and local oscillator _(left)_ and three IF amplification stages and a detector stage _(right)_. The intermediate frequency was 75 kHz. ]]
...
Superheterodyne_image_problem.svg One major disadvantage to the superheterodyne receiver is the problem of _image frequency_. In heterodyne receivers, an image frequency is an undesired input frequency equal to the station frequency plus (or minus) twice the intermediate frequency. The image frequency results in two stations being received at the same time, thus producing interference. Image frequencies can be eliminated by sufficient attenuation on the incoming signal by the RF amplifier filter of the superheterodyne receiver.
