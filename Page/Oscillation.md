...
In addition, an oscillating system may be subject to some external force, as when an AC circuit is connected to an outside power source. In this case the oscillation is said to be _driven_.
...
Oscillation Category:Earthquake engineering

[1] Strogatz, Steven. _Sync: The Emerging Science of Spontaneous Order_. Hyperion, 2003, pp 106-109