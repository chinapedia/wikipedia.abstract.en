...
In May 2008, an extension of this line to Tonkolili with conversion to (standard gauge) upgrade to carry per year was under consideration.[2] [3] Further details of the project were announced in October 2010; Dawnus planned to construct 50 km of new line, and refurbish 67 km of existing line.[4]
...
There are ten airports in Sierra Leone, of which one has paved runways (the length of which exceeds ). Of the remaining airports, all of which having unpaved runways, seven have runways of lengths between ; the remaining two having runways of shorter length. There are two heliports in the country.
...
[2] Railways Africa - SIERRA LEONE RAIL PROJECT

[3] allAfrica.com: Sierra Leone: African Minerals to Boost Bunbuna Hydro (Page 1 of 1)
