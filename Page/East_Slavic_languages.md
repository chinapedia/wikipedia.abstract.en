...
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Isoglosses                          | Northern | Standard Russian | Southern                         | Belarusian      | Ukrainian | Examples |
|                                     | Russian  | (Moscow dialect) | Russian                          |                 |           |          |
+=====================================+==========+==================+==================================+=================+===========+==========+
| reduction                           | no       | yes[2]           | no[3]                            |                 |           |          |
| of unstressed (akanye)              |          |                  |                                  |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| pretonic (yakanye)                  |          |                  |                                  | [4]             | R. ,      |          |
|                                     |          |                  |                                  |                 | B. ,      |          |
|                                     |          |                  |                                  |                 | U.        |          |
|                                     |          |                  |                                  |                 | "earth"   |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Proto-Slavic *_i_                   |          | [5]              | R. ,                             |                 |           |          |
|                                     |          |                  | B. ,                             |                 |           |          |
|                                     |          |                  | U.                               |                 |           |          |
|                                     |          |                  | "leaf"                           |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
...
| Proto-Slavic *_c_                   | [8]      |                  |                                  |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Proto-Slavic *_č_                   | [9]      |                  |                                  | R. ,            |           |          |
|                                     |          |                  |                                  | B. ,            |           |          |
|                                     |          |                  |                                  | U.              |           |          |
|                                     |          |                  |                                  | "time (of day)" |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Proto-Slavic *_skj_, _zgj_          | ,[10]    | ,                | ,                                |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| soft dental stops                   | , [11]   | ,                | ,                                |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Proto-Slavic *_v_                   |          |                  |                                  |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| (including devoiced )               | [12]     |                  |                                  |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Prothetic                           | no[13]   | yes              |                                  |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Proto-Slavic *_g_                   |          |                  |                                  |                 |           |          |
...
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Hardening of soft                   | no       | yes              | partially                        |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Proto-Slavic *_CrьC, ClьC,          | , ,      | , ,              | , ,                              |                 |           |          |
| CrъC, CrъC_                         | ,        | ,                | ,                                |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Proto-Slavic *-_ъj-_, -_ьj_-        | ,        | ,                |                                  |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Proto-Slavic adj. end. *_-ьjь_      |          | ,[14]            | [15]                             |                 | ,         |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Proto-Slavic adj. end. *_-ъjь_      |          | ,[16]            | [17]                             |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Loss of the vocative case           | no       | yes[18]          | no                               |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| 3 sg. & pl. pres. ind.              |          |                  |                                  |                 |           |          |
+-------------------------------------+----------+------------------+----------------------------------+-----------------+-----------+----------+
| Dropping out                        | no       | yes              |                                  |                 |           |          |
...
East_Slavic_languages Category:Slavic languages

[1] [http://www.rusyn.org/images/1.%20Language%20of%20Carpathian%20Rus'.pdf Dulichenko, Aleksandr _The language of Carpathian Rus': Genetic Aspects_]

[2] Except for the Polesian dialect of Brest

[3] Except for the Eastern Polesian dialect

[4] Consonants are hard before

[5] Except for some dialects

[6] In some Ukrainian dialects CC can be

[7] In some Ukrainian dialects PSl *_ě_ can be

[8] Can be in South Russian

[9] Can be in Southern Russian

[10] Can be ,

[11] In Russian light affrication can occur: ,

[12] In some Northern Russian sub-dialects is not devoiced to

[13] Except for _восемь_ "eight" and some others

[14] Only unstressed, Church Slavonic influence

[15] Stressed, unstressed is usually reduced to

[16]

[17] Stressed, unstressed is usually reduced to

[18] New vocative from a pure stem: мам, пап, Машь, Вань etc.
