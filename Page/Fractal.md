...
Analytically, fractals are usually nowhere differentiable.[9][10][11] An infinite fractal curve can be conceived of as winding through space differently from an ordinary line – although it is still 1-dimensional, its fractal dimension indicates that it also resembles a surface.[12][13] (to level 6), a fractal with a topological dimension of 1 and a Hausdorff dimension of 1.893]]
...
using L-systems principles[102]]] Images of fractals can be created by fractal generating programs. Because of the butterfly effect, a small change in a single variable can have an unpredictable outcome.
