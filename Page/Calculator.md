...
Interior_of_a_calculator.jpg In general, a basic electronic calculator consists of the following components:[2]
...
The Casio Computer Company, in Japan, released the Model _14-A_ calculator in 1957, which was the world's first all-electric (relatively) compact calculator. It did not use electronic logic but was based on relay technology, and was built into a desk. LED_DISP.JPG (LED) display from the 1970s (USSR)]]
...
Olivetti_Programma_101_-_Museo_scienza_e_tecnologia_Milano.jpg, the first commercial programmable desktop computer, produced by Olivetti in 1964]]
