...
--Collates key-based table of classes into usable class list function collateClassList (listTable)
...
--Passes through single argument from parent frame function p.group (frame)
