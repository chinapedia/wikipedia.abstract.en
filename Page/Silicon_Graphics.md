...
Ed McCracken was CEO of Silicon Graphics from 1984 to 1997.[3] During those years, SGI grew from annual revenues of $5.4 million to $3.7 billion.[4]
...
SGI emerged from bankruptcy protection on October 17, 2006.[10] Its stock symbol at that point, _SGID.pk_, was canceled, and new stock was issued on the NASDAQ exchange under the symbol _SGIC_.[11] This new stock was distributed to the company's creditors, and the SGID common stockholders were left with worthless shares.[12] At the end of that year, the company moved its headquarters from Mountain View to Sunnyvale.[13] Its earlier North Shoreline headquarters is now occupied by the Computer History Museum; the newer Amphitheater Parkway headquarters was sold to Google. Both of these locations were award-winning designs by Studios Architecture.[14][15]
...
An SGI Crimson system with the fsn[47] three-dimensional file system navigator appeared in the 1993 movie _Jurassic Park_.[48]

In the movie _Twister_, protagonists can be seen using an SGI laptop computer; however, the unit shown was not an actual working computer, but rather a fake laptop shell built around an SGI Corona LCD flat screen display.[49]

The 1995 film _Congo_ also features an SGI laptop computer being used by Dr. Ross (Laura Linney) to communicate via satellite to TraviCom HQ.[50]

The purple, lowercased "SGI" logo can be seen at the beginning of the opening credits of the HBO series _Silicon Valley_, before being taken down and replaced by the Google logo as the intro graphics progress. Google leased the former SGI buildings in 2003 for their headquarters in Mountain View, CA until they purchased the buildings outright in 2006.

For eight consecutive years (1995–2002), all films nominated for an Academy Award for Distinguished Achievement in Visual Effects were created on Silicon Graphics computer systems.[51]
...
The 1995 film Toy Story used Silicon Graphics' Indigo2 computers to create scenes for the movie.
...
In February 1996, SGI purchased the well-known supercomputer manufacturer Cray Research for $740 million,[52] and began to use marketing names such as "CrayLink" for (SGI-developed) technology integrated into the SGI server line. Three months later, it sold the Cray Business Systems Division, responsible for the CS6400 SPARC/Solaris server, to Sun Microsystems for an undisclosed amount (acknowledged later by a Sun executive to be "significantly less than $100 million").[53][54] Many of the Cray T3E engineers designed and developed the SGI Altix and NUMAlink technology. SGI sold the Cray brand and product lines to Tera Computer Company on March 31, 2000, for $35 million plus one million shares.[55] SGI also distributed its remaining interest in MIPS Technologies through a spin-off effective June 20, 2000.
...
In January 2003, SGI announced a variant of the SN platform called the Altix 3000 (internally called SN-IA). It used Intel Itanium 2 processors and ran the Linux operating system kernel. At the time it was released, it was the world's most scalable Linux-based computer, supporting up to 64 processors in a single system node.[58] Nodes could be connected using the same NUMAlink technology to form what SGI predictably termed "superclusters".
...
In April 2004, SGI announced the sale of its Alias software business for approximately $57 million.[59]
...
In July 2006, SGI announced an SGI Altix 4700 system with 1,024 processors and 4 TB of memory running a single Linux system image.[60]


Hardware products

Some 68k and MIPS-based models were also rebadged by other vendors, including CDC, Tandem Computers, Prime Computer and Siemens-Nixdorf. SGI Onyx and SGI Indy series systems were used for game development for the Nintendo 64.
...
Silicon_Graphics Category:1981 establishments in California Category:2009 disestablishments in California Category:American companies established in 1981 Category:Companies based in Mountain View, California Category:Companies based in Silicon Valley Category:Companies based in Sunnyvale, California Category:Companies delisted from the New York Stock Exchange Category:Companies that filed for Chapter 11 bankruptcy in 2006 Category:Companies that filed for Chapter 11 bankruptcy in 2009 Category:Computer companies established in 1981 Category:Computer companies of the United States Category:Defunct companies based in the San Francisco Bay Area Category:Defunct computer hardware companies Category:Defunct semiconductor companies of the United States Category:Defunct software companies of the United States Category:Design companies established in 1981 Category:Electronics companies established in 1981 Category:Electronics companies of the United States Category:Graphics hardware companies Category:Technology companies based in the San Francisco Bay Area Category:Technology companies disestablished in 2009 Category:Technology companies established in 1981

[1]

[2] The First Quarter-Century, Silicon Graphics, 2007.
...
[21]  (selected items from the court docket, Case # 09-11701, United States Bankruptcy Court, Southern District of New York, Judge Martin Glenn)
...
[37] http://www.bitsavers.org/pdf/sgi/iris/IRIS_FAQ.txt

[38]

[39] PC Magazine. "SGI." Retrieved September 19, 2011.

[40] Computer History Museum. "Silicon Graphics Professional IRIS 4D/50GT." Retrieved September 19, 2011.

[41] Cate Corcoran (March 16, 1992), MIPS, Silicon merger could kill ACE/ARC, _InfoWorld_, pp. 1 and 107. Retrieved September 19, 2011.

[42] Cate Corcoran (March 16, 1992), MIPS, Silicon merger could kill ACE/ARC, InfoWorld, p. 107. Retrieved September 19, 2011.
...
[46] End of General Availability for MIPS IRIX Products at sgi.com

[47] FSN — File System Navigator at siliconbunny.com

[48]

[49] Banned From the Ranch Entertainment — Twister at bftr.com.

[50] SGI Laptops at siliconbunny.com

[51]

[52] David Einstein, Could SGI Be A Takeover Target? Forbes, March 2000.
...
[57] Silicon Graphics "SGI SEWP Contracts" Retrieved November 11, 2011.

[58] Scaling Linux to New Heights: the SGI Altix 3000 System Linux Journal, January 2003
