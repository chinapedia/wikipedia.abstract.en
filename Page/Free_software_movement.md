...
Encerramento_do_FISL_16.jpg and Tux mascots around free software supporters at FISL 16]]
...
The French gendarmerie and the French National Assembly utilize Linux.[14]
...
Gov.uk keeps a list of "key components, tools and services that have gone into the construction of GOV.UK".[17]
...
Eric Raymond criticises the speed at which the free software movement is progressing, suggesting that temporary compromises should be made for long-term gains. Raymond argues that this could raise awareness of the software and thus increase the free software movement's influence on relevant standards and legislation.[47]

Richard Stallman, on the other hand, sees the current level of compromise as a greater cause for worry.[48][49][50]

How will programmers get paid?

Stallman said that this is where people get the misconception of "free": there is no wrong in programmers' requesting payment for a proposed project. Restricting and controlling the user's decisions on use is the actual violation of freedom. Stallman defends that in some cases, monetary incentive is not necessary for motivation since the pleasure in expressing creativity is a reward in itself.[51] On the other hand, Stallman admits that is not easy to raise money for FOSS projects.[52]

"Viral" licensing

The free software movement champions copyleft licensing schema (often pejoratively called "viral licenses"). In its strongest form, copyleft mandates that any works _derived_ from copyleft-licensed software must also carry a copyleft license, so the license spreads from work to work like a computer virus might spread from machine to machine. These licensing terms can only be enforced through asserting copyrights.[53] Critics of copyleft licensing challenge the idea that restricting modifications is in line with the free software movement's emphasis on various "freedoms," especially when alternatives like MIT, BSD, and Apache licenses are more permissive.[54][55] Proponents enjoy the assurance that copylefted work cannot usually be incorporated into non-free software projects.[56] They emphasize that copyleft licenses may not attach for all uses and that in any case, developers can simply choose not to use copyleft-licensed software.[57][58]

License proliferation and compatibility

FOSS license proliferation is a serious concern in the FOSS domain due to increased complexity of license compatibility considerations which limits and complicates source code reuse between FOSS projects.[59] The OSI and the FSF maintain own lists of dozens of existing and acceptable FOSS licenses.[60] There is an agreement among most that the creation of new licenses should be minimized at all cost and these created should be made compatible with the major existing FOSS licenses. Therefore, there was a strong controversy around the update of the GPLv2 to the GPLv3 in 2007,[61][62] as the updated license is not compatible with the previous version.[63][64][65] Several projects (mostly of the open source faction[66] like the Linux kernel[67][68]) decided to not adopt the GPLv3 while the GNU projects adopted the GPLv3.
...
-   -   David M. Berry, _Copy, Rip, Burn: The Politics of Copyleft and Open Source_, Pluto Press, 2008,
-   Johan Söderberg, _Hacking Capitalism: The Free and Open Source Software Movement_, Routledge, 2007,
...
-   Christian Imhorst, [http://www.imhorst.net/translations/anarchy-and-source-code/ _Anarchy and Source Code - What does the Free Software Movement have to do with Anarchism?]_, (licence: GFDL), 2005
-   An anti-DRM campaign - by Bill Xu and Richard Stallman
-   Stallman's Free Software Song

Category:Copyleft media Category:Free software culture and documents Free_software_movement
...
[17] http://archive.is/FGnIN

[18] https://libreplanet.org/wiki/Group:Free_Software_in_Government#Uruguay
...
[23] Coleman (2013), p. 116-7.

[24] Söderberg (2007), p. 153-4.

[25] Pragmatism in the History of GNU, Linux and Free/Open Source Software Jun 9, 2015 Christopher Tozzi
...
[34]  June 2009 {{!}} Communications of the ACM|last=Stallman|first=Richard|website=cacm.acm.org|access-date=2017-10-17}}
