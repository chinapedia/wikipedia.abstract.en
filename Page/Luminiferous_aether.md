...
While the _first_-order experiments could be explained by a modified stationary aether, more precise _second_-order experiments were expected to give positive results, however, no such results could be found.
