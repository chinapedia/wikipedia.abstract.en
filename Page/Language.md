...
using Canadian Aboriginal syllabics, an abugida developed by Christian missionaries for Indigenous Canadian languages]] Throughout history a number of different ways of representing language in graphic media have been invented. These are called writing systems.
...
'', written in Old English in the early medieval period (800–1100 AD). Although Old English is the direct ancestor of modern English, it is unintelligible to contemporary English speakers.]] All languages change as speakers adopt or invent new ways of speaking and pass them on to other members of their speech community. Language change happens at all levels from the phonological level to the levels of vocabulary, morphology, syntax, and discourse. Even though language change is often initially evaluated negatively by speakers of the language who often consider changes to be "decay" or a sign of slipping norms of language usage, it is natural and inevitable.[123]
