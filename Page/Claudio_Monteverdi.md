Bernardo_Strozzi_-_Claudio_Monteverdi_(c.1630).jpg (c. 1630)]]
...
Claudio_Monteverdi,_engraved_portrait_from_'Fiori_poetici'_1644_-_Beinecke_Rare_Book_Library_(adjusted).jpg
...
Monteverdiletter.jpg, MS Mus. 1707), discussing the composer's _intermezzo, Didone ed Enea_[52]]]
...
Frontispiece_of_L'Orfeo.jpg The opera opens with a brief trumpet toccata. The prologue of La musica (a figure representing music) is introduced with a ritornello by the strings, repeated often to represent the "power of music" – one of the earliest examples of an operatic leitmotif.[109] Act 1 presents a pastoral idyll, the buoyant mood of which continues into Act 2. The confusion and grief which follow the news of Euridice's death are musically reflected by harsh dissonances and the juxtaposition of keys. The music remains in this vein until the act ends with the consoling sounds of the ritornello.[110]
