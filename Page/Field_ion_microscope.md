...
1.  The tip potential is positive.
2.  The chamber is filled with an imaging gas (typically, He or Ne at 10^(−5) to 10^(−3) Torr).
...
Category:Microscopes Category:Scientific techniques
