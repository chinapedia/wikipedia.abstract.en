is a common symbol used by Presbyterian churches; here as used by the Presbyterian Church in Ireland.[1] Latin inscription underneath translates as "burning but flourishing". In Presbyterianism, alternative versions of the motto are also used such as "burning, yet not consumed".]] PRESBYTERIANISM is a part of the Reformed tradition within Protestantism, which traces its origins to Britain, particularly Scotland.
...
, 19th century]] Historically, the driving principle in the development of the standards of Presbyterian worship is the Regulative principle of worship, which specifies that (in worship), what is not commanded is forbidden.[29]
...
, New Zealand]] In New Zealand, Presbyterian is the dominant denomination in Otago and Southland due largely to the rich Scottish and to a lesser extent Ulster-Scots heritage in the region. The area around Christchurch, Canterbury, is dominated philosophically by the Anglican (Episcopalian) denomination.
