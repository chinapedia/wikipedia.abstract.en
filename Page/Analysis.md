...
The word comes from the Ancient Greek ἀνάλυσις (_análusis_, "a breaking up", from _ana-_ "up, throughout" and _lusis_ "a loosening").[2]

As a formal concept, the method has variously been ascribed to Alhazen,[3] René Descartes (_Discourse on the Method_), and Galileo Galilei. It has also been ascribed to Isaac Newton, in the form of a practical method of physical discovery (which he did not name).
...
-   _Analysis_ is the name of a prominent journal in philosophy.
...
In statistics, the term _analysis_ may refer to any method used for data analysis. Among the many such methods, some are:
...
-   Regression analysis – techniques for analyzing the relationships between several predictive variables and one or more outcomes in the data
...
Category:Critical thinking skills Category:Research methods Analysis
