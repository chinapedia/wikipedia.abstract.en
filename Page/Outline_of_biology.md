...
-   {{visible anchor – study of animals, including classification, physiology, development, and behavior. Subbranches include:
    ...
    -   {{visible anchor – scientific and objective study of animal behaviour, usually with a focus on behaviour under natural conditions.
...
-   GENETICS (classical genetics) :
    ...
    -   Model organisms: _Drosophila_ – _Arabidopsis_ – _Caenorhabditis elegans_ – mouse – _Saccharomyces cerevisiae_ – _Escherichia coli_ – Lambda phage – _Xenopus_ – chicken – zebrafish – _Ciona intestinalis_ – amphioxus
...
-   OSU's Phylocode
-   _The Tree of Life_: A multi-authored, distributed Internet project containing information about phylogeny and biodiversity.
...
Biology Biology Biology-related_lists
