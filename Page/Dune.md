...
The modern word "dune" came into English from French 1790,[2] which in turn came from Middle Dutch _dūne_.[3]
...
Five basic dune types are recognized: crescentic, linear, star, dome, and parabolic. Dune areas may occur in three forms: simple (isolated dunes of basic type), compound (larger dunes on which smaller dunes of same type form), and complex (combinations of different types).[4]
...
Abundant barchan dunes may merge into barchanoid ridges, which then grade into linear (or slightly sinuous) transverse dunes, so called because they lie transverse, or across, the wind direction, with the wind blowing perpendicular to the ridge crest.[6]

Seif or longitudinal dunes

Seif dunes are linear (or slightly sinuous) dunes with two slip faces.[7] The two slip faces make them sharp-crested. They are called _seif_ dunes after the Arabic word for "sword". They may be more than 160 kilometres (100 miles) long, and thus easily visible in satellite images (see illustrations).

Seif dunes are associated with bidirectional winds. The long axes and ridges of these dunes extend along the resultant direction of sand movement (hence the name "longitudinal").[8] Some linear dunes merge to form Y-shaped compound dunes.[9]

Formation is debated. Bagnold, in _The Physics of Blown Sand and Desert Dunes_, suggested that some seif dunes form when a barchan dune moves into a bidirectional wind regime, and one arm or wing of the crescent elongates. Others suggest that seif dunes are formed by vortices in a unidirectional wind.[10] In the sheltered troughs between highly developed seif dunes, barchans may be formed, because the wind is constrained to be unidirectional by the dunes.

File:Rub' al Khali (Arabian Empty Quarter) sand dunes imaged by Terra (EOS AM-1).jpg|alt = On the left, more barchany dunes, with the crescent arms pointing towards the bottom edge of the image and slightly rightwards. To the right, dunes look increasingly linear, with long ridges running about 20 degrees bottomwards of due right|Rub' al Khali (Arabian Empty Quarter) sand dunes imaged by Terra (EOS AM-1). Most of these dunes are seif dunes. Their origin from barchans is suggested by the stubby remnant "hooks" seen on many of the dunes. Wind would be from left to right. File:ISS-31 Linear dunes in the Great Sand Sea in southwest Egypt.jpg|Large linear seif dunes in the Great Sand Sea in southwest Egypt, seen from the International Space Station. The distance between each dune is 1.5–2.5 km. File:Longitudinal_dune.jpg%7CThe average-direction-longitudinal model of seif dune formation. File:Tranverse dune.jpg|alt=Transverse dune with wind blowing across crest|By contrast, transverse dunes form with the wind blowing perpendicular to the ridges, and have only one slipface, on the lee side. The stoss side is less steep. File:Cross-bedding.gif%7Calt=Animation of wind pushing transverse dunes along. The sand blows from the stoss side down onto the less side, where it is buried by the next layer. The dune thus moves, and a cross-section through it shown diagonal cross-bedding|Transverse dunes lie perpendicular to the wind, which moves them forwards, producing the cross-bedding shown here.
...
A type of extensive parabolic dune that lacks discernible slipfaces and has mostly coarse grained sand is known as a _zibar_.[12] The term zibar comes from the Arabic word to describe "rolling transverse ridges ... with a hard surface".[13] The dunes are small, have low relief, and can be found in many places across the planet from Wyoming (United States) to Saudi Arabia to Australia. Spacing between zibars ranges from 50 to 400 metres and they don't become more than 10 metres high.[14] The dunes form at about ninety degrees to the prevailing wind which blows away the small, fine-grained sand leaving behind the coarser grained sand to form the crest.[15]
...
-   Prostrate growth form to avoid wind/salt spray (_Abronia spp_., Beach Primrose)
-   Krummholz growth form (Monterrey Cypress-not a dune plant but deals with similar pressures)
-   Thickened cuticle/Succulence to reduce moisture loss and reduce salt uptake (_Ambrosia/Abronia spp., Calystegia soldanella_)
-   Pale leaves to reduce insolation (_Artemisia/Ambrosia spp._)
-   Thorny/Spiky seeds to ensure establishment in vicinity of parent, reduces chances of being blown away or swept our to sea (_Ambrosia chamissonis_)
...
Sub-aqueous (underwater) dunes form on a bed of sand or gravel under the actions of water flow. They are ubiquitous in natural channels such as rivers and estuaries, and also form in engineered canals and pipelines.[40][41][42] Dunes move downstream as the upstream slope is eroded and the sediment deposited on the downstream or lee slope in typical bedform construction.[43] In the case of sub-aqueous barchan dunes, sediment is lost by their extremities, known as horns.[44][45]

These dunes most often form as a continuous 'train' of dunes, showing remarkable similarity in wavelength and height. The shape of a dune gives information about its formation environment.[46] For instance, rives produce asymmetrical ripples, with the steeper slip face facing downstream. Ripple marks preserved in sedimentary strata in the geological record can be used to determine the direction of current flow, and thus an indication of the source of the sediments.
...
-   Hoge Veluwe National Park, Veluwe, Netherlands
...
-   Indiana Dunes National Park, Indiana, on the south shore of Lake Michigan.Smith, S. & Mark, S. (2006). Alice Gray, Dorothy Buell, and Naomi Svihla: "Preservationists of Ogden Dunes". _The South Shore Journal_, 1.
...
+============================+==============================+===================================+=================================================================================+===========================================================================================+
| Duna Federico Kirbus       | ≈4,035/1,230                 | ≈9,334/2,845                      | Bolsón de Fiambalá, Fiambalá, Catamarca Province, Argentina                     | Highest in the world[54]                                                                  |
+----------------------------+------------------------------+-----------------------------------+---------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
| Cerro Blanco               | ≈3,860/1,176                 | ≈6,791/2,080                      | Nazca Province, Ica Region, Peru                                                | Highest in Peru, second highest in the world                                              |
+----------------------------+------------------------------+-----------------------------------+---------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
| Badain Jaran Dunes         | ≈1,640/500                   | ≈6,640/2,020                      | Badain Jaran Desert, Alashan Plain, Inner Mongolia, Gobi Desert, China          | World's tallest stationary dunes and highest in Asia[55]                                  |
+----------------------------+------------------------------+-----------------------------------+---------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
...
+----------------------------+------------------------------+-----------------------------------+---------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
| Big Daddy/Dune 7           | 1,256/383                    | ≈1,870/570                        | Sossusvlei Dunes, Namib Desert, Namibia / Near Walvis Bay Namib Desert, Namibia | according to the Namibian Ministry of Environment & Tourism the highest dune in the world |
| (Big Mama?)[56]            |                              |                                   |                                                                                 |                                                                                           |
+----------------------------+------------------------------+-----------------------------------+---------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
...
: Note: This table is partially based on estimates and incomplete information. |- style=background:silver; color:black
...
Dunes Category:Aeolian landforms Category:Coastal and oceanic landforms Category:Coastal geography Category:Sedimentology
...
[4] Types of dunes, a USGS publication
...
[11] Twidale, C.R. & Campbell, E.M. (2005, revised edition): Australian landforms: understanding a low, flat, arid and old landscape. Rosenberg Publishing. Pp. 241–3.
...
[43] Prothero, D. R. and Schwab, F., 1996, _Sedimentary Geology_, pg. 45–49,
...
[53] Smith, S. & Mark, S. (2009). "The Historical Roots of the Nature Conservancy in the Northwest Indiana/Chicagoland Region: From Science to Preservation". _The South Shore Journal_, 3.

[54]

[55] "Mystery of world's tallest sand dunes solved"—24 November 2004—_New Scientist_

[56] Big Mama highest dune

[57] Peeking Through the Haze: Titan's Surface, part II—The Planetary Society Blog | The Planetary Society