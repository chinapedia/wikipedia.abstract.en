...
-   Lambda was used as a shield pattern by the Spartan army. This stood for Lacedaemon (), the name of the polis of the Spartans, as opposed to the city itself.
...
-   In NATO military operations, a chevron (a heraldic symbol which looks like an capital letter lambda or inverted V) is painted on the vehicles of this military alliance for identification.
...
-   Lambda is a unit of volume, synonymous with one microliter (1 μL), that is, one cubic millimetre (1 mm³). This use is currently deprecated.
...
-   A block style Lambda is used as a recurring symbol in the Valve Corporation computer game series _Half-Life_,[7] referring to the Lambda complex of the fictional Black Mesa Research Facility, as well as making appearances in the sequel _Half-Life 2_.[8]
...
The Roman _libra_ and Byzantine _lítra_ (), which served as both the pound mass unit and liter volume unit, were abbreviated in Greek using lambda with modified forms of the iota subscript (as λͅ). These are variously encoded in Unicode. The Ancient Greek Numbers Unicode block includes 10183 (𐆃) as well as 𐅢, which is described as 10162 [14] but was much more common as a form of the litra sign. A variant of the sign can be formed from 0338 and either 039B (Λ̸) or 03BB (λ̸).[15]
...
[1] Herbert Weir Smyth. _A Greek Grammar for Colleges_. I.1.c
...
[14] Unicode Ancient Greek Numbers block.

[15]

[16] https://www.unicode.org/mail-arch/unicode-ml/y2010-m06/0063.html