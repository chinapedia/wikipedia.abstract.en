...
-   "_Plain text_ is a pure sequence of character codes; plain Un-encoded text is therefore a sequence of Unicode character codes."
-   _styled text_, also known as _rich text_, is any text representation containing plain text completed by information such as a language identifier, font size, color, hypertext links.[2]
...
Files that contain markup or other meta-data are generally considered plain-text, as long as the entirety remains in directly human-readable form (as in HTML, XML, and so on (as Coombs, Renear, and DeRose argue,[4] punctuation is itself markup). The use of plain text rather than bit-streams to express markup, enables files to survive much better "in the wild", in part by making them largely immune to computer architecture incompatibilities.

According to The Unicode Standard:

-   "_Plain text_ is a pure sequence of character codes; plain Unicode-encoded text is therefore a sequence of Unicode character codes."
-   _styled text_, also known as _rich text_, is any text representation containing plain text completed by information such as a language identifier, font size, color, hypertext links.[5]
...
-   "plain text is the underlying content stream to which formatting can be applied."
-   "Plain text is public, standardized, and universally readable."[6]
...
The best format for storing knowledge persistently is plain text, rather than some binary format.[7]
...
[2] The Unicode Standard, version 6.1, General Structure, page 14

[3]

[4]

[5] The Unicode Standard, version 6.1, General Structure, page 14

[6]

[7] Andrew Hunt, David Thomas. "The Pragmatic Programmer". 1999. Chapter 14: "The Power of Plain Text". p. 73.