...
Phosphatases can be subdivided based upon their substrate specificity.
  ...
  ----------------------------------------- ------------------- ------------------------------------ -----------
  Tyrosine-specific phosphatases            PTP1B               Phosphotyrosine                      [8]
  Serine-/threonine-specific phosphatases   PP2C (PPP2CA)       Phosphoserine/-threonine             [9]
  Dual specificity phosphatases             VHR, DUSP1–DUSP28   Phosphotyrosine/-serine/-threonine   [10]
  Histidine phosphatase                     PHP                 Phospho-Histidine                    [11]
...
Many phosphatases are promiscuous with respect to substrate type, or can evolve quickly to change substrate. An alternative structural classification[12] notes that 20 distinct protein folds have phosphatase activity, and 10 of these contain protein phosphatases.
...
Category:Enzymes Category:Posttranslational modification Category:Signal transduction
