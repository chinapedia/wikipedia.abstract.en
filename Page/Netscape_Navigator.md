...
The competition between Microsoft and Netscape dominated the Browser Wars. Internet Explorer, Version 1.0 (shipped in the Internet Jumpstart Kit in Microsoft Plus! For Windows 95[14]) and IE, Version 2.0 (the first cross-platform version of the web browser, supporting both Windows and Mac OS[15]) were thought by many to be inferior and primitive when compared to contemporary versions of Netscape Navigator. With the release of IE version 3.0 (1996) Microsoft was able to catch up with Netscape competitively, with IE Version 4.0 (1997) further improvement in terms of market share. IE 5.0 (1999) improved stability and took significant market share from Netscape Navigator for the first time.
...
In a 2007 _PC World_ column, the original Netscape Navigator was considered the "best tech product of all time" due to its impact on the Internet.[18]
...
Category:1994 software Category:Cross-platform web browsers Category:Discontinued web browsers Category:Gopher clients Category:History of web browsers Category:Netscape Category:OS/2 web browsers Category:POSIX web browsers
...
[17] BBC News Article retrieved 29 February 2008
