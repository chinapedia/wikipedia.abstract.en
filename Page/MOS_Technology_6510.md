thumb showing the 6510 CPU (40-pin DIP, lower left). The chip on the right is the 6581 SID. The production week/year (WWYY) of each chip is given below its name.]]
...
The 7501/8501 variant of the 6510 was introduced in 1984.[2] Compared to the 6510, this variant extends the number of I/O port pins from 6 to 8, but omits the pins for non-maskable interrupt and clock output.[3]. It was used in Commodore's C16, C116 and Plus/4 home computers, where its I/O port controlled not only the Datasette but also the CBM Bus interface. The main difference between 7501 and 8501 CPUs is that they were manufactured with slightly different processes: 7501 was manufactured with HMOS-1 and 8501 with HMOS-2.[4]
...
Category:65xx microprocessors Category:MOS microprocessors Category:Commodore 64

[1]

[2] http://plus4world.powweb.com/hardware/MOS_75018501 Hardware – MOS 7501/8501

[3] https://ist.uwaterloo.ca/~schepers/MJK/7501.html CPU 7501 / 8501
