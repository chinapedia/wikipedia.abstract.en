...
humans. Radiation in general exists throughout nature, such as in light and sound.]]
...
radiation can be detected in a cloud chamber.]]
...
(beta radiation) detected in an isopropanol cloud chamber]] Beta-minus (β^(−)) radiation consists of an energetic electron. It is more penetrating than alpha radiation, but less than gamma. Beta radiation from radioactive decay can be stopped with a few centimeters of plastic or a few millimeters of metal. It occurs when a neutron decays into a proton in a nucleus, releasing the beta particle and an antineutrino. Beta radiation from linac accelerators is far more energetic and penetrating than natural beta radiation. It is sometimes used therapeutically in radiotherapy to treat superficial tumors.
