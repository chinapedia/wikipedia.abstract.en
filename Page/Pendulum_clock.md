...
-   Striking train: strikes a bell or gong on every hour, with the number of strikes equal to the number of the hour. Some clocks will also signal the half hour with a single strike. More elaborate types, technically called _chiming clocks_, strike on the quarter hours, and may play melodies or Cathedral chimes, usually Westminster quarters.
...
Category:Clocks Category:Pendulums Category:Inventions by Christiaan Huygens Category:Oscillators
...
[5] A modern reconstruction can be seen at

[6] , p.3, also published in ''Proceedings of the Royal Society of London, _A_ 458, 563–579
