...
The oldest society is 'The Model Railway Club'[4] (established 1910), near Kings Cross, London, UK. As well as building model railways, it has 5,000 books and periodicals. Similarly, 'The Historical Model Railway Society'[5] at Butterley, near Ripley, Derbyshire specialises in historical matters and has archives available to members and non-members.


Scales and gauges

The words _scale_ and _gauge_ seem at first interchangeable but their meanings are different. _Scale_ is the model's measurement as a proportion to the original, while _gauge_ is the measurement between the rails.
...
| -   Accurail                                     | -   Lego train                                     |
| -   Accurascale                                  | -   Lemaco                                         |
| -   Airfix                                       | -   -   -   Lesney (Matchbox)                      |
| -   Acme                                         | -   Lehmann Gross Bahn                             |
| -   American Flyer                               | -   Life-Like                                      |
| -   American Z Lines                             | -   Liliput                                        |
| -   Aristo-Craft Trains                          | -   Lima                                           |
| -   AR Kits                                      | -   Lionel, LLC                                    |
| -   Arnold                                       | -   LS Models                                      |
| -   Associated Hobby Manufacters (AHM) (defunct) | -   Marx                                           |
| -   Athearn                                      | -   Mainline                                       |
| -   Atlas Model Railroad                         | -   Mantua, later Tyco Toys (both defunct by 2001) |
| -   Auhagen                                      | -   Märklin                                        |
| -   Ausicison                                    | -   Mehano                                         |
| -   Austrains                                    | -   Merkur (toy)                                   |
| -   Austrains NEO                                | -   Merten (model railway)                         |
| -   Bachmann Industries                          | -   Micro-Trains Line                              |
| -   Bassett-Lowke                                | -   Minitrains                                     |
| -   Bavaria                                      | -   Mistral Train Models                           |
| -   -   Bing                                     | -   Model Power                                    |
| -   Bowser Manufacturing                         | -   Modemo (Hasegawa)                              |
| -   Bachmann                                     | -   MTH Electric Trains                            |
| -   Broadway Limited Imports (BLI)               | -   Noch                                           |
| -   Con-Cor                                      | -   Norsk Modelljernbane (NMJ)                     |
| -   Dapol                                        | -   Oxford Rail                                    |
| -   Doepke (defunct)                             | -   Peco                                           |
| -   DJH Models and Kits                          | -   Piko                                           |
| -   DJ Models Ltd                                | -   Playcraft (defunct)                            |
| -   Exley                                        | -   Playmobil                                      |
| -   Eggerbahn                                    | -   Powerline model railway                        |
| -   ExactRail                                    | -   Rapido                                         |
| -   Eureka Models                                | -   Rapido Trains (Canada)                         |
| -   Faller                                       | -   REE Modèles                                    |
| -   Ferris (defunct)                             | -   Rio Grande Models, Ltd.                        |
| -   Fleischmann                                  | -   Rivarossi                                      |
| -   Frateschi                                    | -   Roco                                           |
| -   Fulgurex                                     | -   Rokal                                          |
| -   G .& R. Wrenn Ltd                            | -   Rokuhan                                        |
| -   Golden Age Models Limited                    | -   Scaletrains                                    |
| -   Graham Farish ("Grafar")                     | -   Seven                                          |
| -   Great West Models                            | -   Southern Rail Models                           |
| -   Gützold                                      | -   SDS Models                                     |
| -   HAG                                          | -   SceneryScapers                                 |
| -   Hartlan Locomotive Works                     | -   Stewart Hobbies                                |
| -   Haskell                                      | -   Tenshodo                                       |
| -   Heljan                                       | -   Tomix                                          |
| -   Herpa                                        | -   -   Tillig                                     |
| -   Hornby Railways                              | -   Bob's Hobbies and Models (Trainorama)          |
| -   Ibertren                                     | -   Tri-ang Railways                               |
| -   Intermountain                                | -   Trix/Minitrix                                  |
| -   International Hobby Corp.                    | -   USA Trains                                     |
| -   Irish Railway Models                         | -   Varney                                         |
| -   Ives Manufacturing Company (defunct 1928)    | -   Viessmann                                      |
| -   Jouef                                        | -   Vitrains                                       |
| -   Kadee                                        | -   Vollmer                                        |
| -   Kato Precision Railroad Models               | -   Von Stetina Artworks                           |
| -   Kemtron Corporation (defunct 1964)           | -   Wiking                                         |
| -   Klein Modellbahn                             | -   Walthers                                       |
| -   Kleinbahn                                    | -   Williams                                       |
| -   Kres (model railway)[10]                     | -   Woodland Scenics                               |
| -   Kuehn-modell                                 | -   Worsley Works                                  |
|                                                  | -   Wuiske                                         |
+--------------------------------------------------+----------------------------------------------------+
...
-   N-orma,[14] Polish N-scale (1:160) modules organization.
...
Rail_transport_modelling Miniature_railways
