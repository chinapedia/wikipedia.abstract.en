...
CodinGame also serves as a recruiting platform, allowing developers to get noticed by companies based on their performance on the contests.[1]
...
CodinGame's business model is based on sponsoring by companies wanting to get in touch with developers. CodinGame helps these company to recruit developers through worldwide contests hosted every three months,[2] or private hackathons. The startup was also seeded through several fundraisings in 2013 and 2015.[3]
...
Category:Programming contests Category:Computer science competitions Category:Educational websites Category:Problem solving Category:Puzzles Category:Programming games
