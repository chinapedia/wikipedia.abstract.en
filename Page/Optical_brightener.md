...
DAMBDSacid.png is a popular optical brightener.]] 2_5-bis(benzoxazol-2-yl)thiophene.svg
...
Brighteners are commonly added to laundry detergents to make the clothes appear cleaner. Normally cleaned laundry appears yellowish, which consumers do not like.[3][4] Optical brighteners have replaced bluing which was formerly used to produce the same effect.
...
Category:Fluorescent dyes Category:Cleaning product components Category:Luminescence Category:Papermaking Category:Process chemicals

[1] Eduard Smulders, Wolfgang Rybinski, Eric Sung, Wilfried Rähse, Josef Steber, Frederike Wiebel, Anette Nordskog, "Laundry Detergents" in Ullmann’s Encyclopedia of Industrial Chemistry 2002, Wiley-VCH, Weinheim.
