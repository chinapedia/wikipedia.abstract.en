...
The term _cDNA_ is also used, typically in a bioinformatics context, to refer to an mRNA transcript's sequence, expressed as DNA bases (GCAT) rather than RNA bases (GCAU).
...
1.  An eukaryotic cell transcribes the DNA (from genes) into RNA (pre-mRNA).
...
On June 13, 2013, the United States Supreme Court ruled in the case of _Association for Molecular Pathology v. Myriad Genetics_ that while naturally occurring human genes cannot be patented, cDNA is patent eligible because it does not occur naturally.[2]
