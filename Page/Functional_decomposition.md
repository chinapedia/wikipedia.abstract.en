...
Chow-liu.pngFor a multivariate function y = f(x₁, x₂, …, x_(n)), functional decomposition generally refers to a process of identifying a set of functions {g₁, g₂, …g_(m)} such that
