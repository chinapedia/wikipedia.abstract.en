cuboctahedron showing seven crystallographic planes, imaged with scanning electron microscopy]]
...
nanostructure]] Nanostructure deals with objects and structures that are in the 1–100 nm range.[10] In many materials, atoms or molecules agglomerate together to form objects at the nanoscale. This causes many interesting electrical, magnetic, optical, and mechanical properties.
...
image of carbon nanotubes bundles]] Nanomaterials describe, in principle, materials of which a single unit is sized (in at least one dimension) between 1 and 1000 nanometers (10^(−9) meter) but is usually 1–100 nm.
