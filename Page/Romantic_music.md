...
Such lists, however, proliferated over time, resulting in a "chaos of antithetical phenomena", criticized for their superficiality and for signifying so many different things that there came to be no central meaning. The attributes have also been criticized for being too vague. For example, features of the "ghostly and supernatural" could apply equally to Mozart's _Don Giovanni_ from 1787 and Stravinsky's _The Rake's Progress_ from 1951 .
...
-   The use of a wider range of dynamics, for example from to , supported by large orchestration;
...
Category:19th century in music Category:Romantic composers Romantic_music Category:Romanticism