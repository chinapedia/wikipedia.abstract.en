...
, _The tax collector's office_, 1640]]
...
revenue, in % of GDP, from social contributions. For this data, the variance of GDP per capita with purchasing power parity (PPP) is explained in 20 % by social contributions revenue.]]
...
revenue from taxes in % of GDP. For this data, the variance of GDP per capita with purchasing power parity (PPP) is explained in 32 % by tax revenue.]]
