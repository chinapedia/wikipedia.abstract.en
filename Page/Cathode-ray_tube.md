...
These are found in _analog phosphor storage oscilloscopes_. These are distinct from _digital storage oscilloscopes_ which rely on solid state digital memory to store the image.
