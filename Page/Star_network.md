...
-   If one node or its connection breaks, it does not affect the other computers nor their connections[3]
...
-   Expensive due to the number and length of cables needed to wire each host to the central hub[4]
