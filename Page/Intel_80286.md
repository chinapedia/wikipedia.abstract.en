...
KL_AMD_80286_CLCC_Bottom.jpg Intel's first 80286 chips were specified for a maximum clockrate of 4, 6 or 8 MHz and later releases for 12.5 MHz. AMD and Harris later produced 16 MHz, 20 MHz and 25 MHz parts, respectively. Intersil and Fujitsu also designed fully static CMOS versions of Intel's original depletion-load nMOS implementation, largely aimed at battery-powered devices.

On average, the 80286 was reportedly measured to have a speed of about 0.21 instructions per clock on "typical" programs,[5] although it could be significantly faster on optimized code and in tight loops, as many instructions could execute in 2 clock cycles each. The 6 MHz, 10 MHz and 12 MHz models were reportedly measured to operate at 0.9 MIPS, 1.5 MIPS and 2.66 MIPS respectively.[6]

The later E-stepping level of the 80286 was free of the several significant errata that caused problems for programmers and operating-system writers in the earlier B-step and C-step CPUs (common in the AT and AT clones).[7]


Architecture

Intel_i80286_arch.svg Intel_80286_die.JPG The 80286 was designed for multi-user systems with multitasking applications, including communications (such as automated PBXs) and real-time process control. It had 134,000 transistors and consisted of four independent units: address unit, bus unit, instruction unit and execution unit, organized into a loosely coupled (buffered) pipeline just as in the 8086. The significantly increased performance over the 8086 was primarily due to the non-multiplexed address and data buses, more address-calculation hardware (most importantly, a dedicated adder) and a faster (more hardware-based) multiplier.[8] It was produced in a 68-pin package, including PLCC (plastic leaded chip carrier), LCC (leadless chip carrier) and PGA (pin grid array) packages.[9]
...
-   Intel 80286 Programmer's Reference Manual 1987 (txt). Hint: use e.g. _Hebrew (IBM-862)_ encoding.
...
Category:Computer-related introductions in 1982 80286

[1]

[2]

[3] A simpler cousin in the 8086-line with integrated peripherals, intended for embedded systems.
...
[21] http://www.tenox.net/docs/microsoft_xenix_30_286_press_release.pdf.

[22] http://textfiles.com/internet/FAQ/coherent.faq.

[23] http://minix.net/minix/minix.html.

[24] Charles Petzold, Intel's 32-bit Wonder: The 80386 Microprocessor, _PC Magazine_, November 25, 1986, pp. 150–152.
