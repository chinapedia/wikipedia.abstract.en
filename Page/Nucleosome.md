...
A recent advance in the production of nucleosome core particles with enhanced stability involves site-specific disulfide crosslinks.[77] Two different crosslinks can be introduced into the nucleosome core particle. A first one crosslinks the two copies of H2A via an introduced cysteine (N38C) resulting in histone octamer which is stable against H2A/H2B dimer loss during nucleosome reconstitution. A second crosslink can be introduced between the H3 N-terminal histone tail and the nucleosome DNA ends via an incorporated convertible nucleotide.[78] The DNA-histone octamer crosslink stabilizes the nucleosome core particle against DNA dissociation at very low particle concentrations and at elevated salt concentrations.
...
Histones H3 and H4 from disassembled old nucleosomes are kept in the vicinity and randomly distributed on the newly synthesized DNA.[79] They are assembled by the chromatin assembly factor-1 (CAF-1) complex, which consists of three subunits (p150, p60, and p48).[80] Newly synthesized H3 and H4 are assembled by the replication coupling assembly factor (RCAF). RCAF contains the subunit Asf1, which binds to newly synthesized H3 and H4 proteins.[81] The old H3 and H4 proteins retain their chemical modifications which contributes to the passing down of the epigenetic signature. The newly synthesized H3 and H4 proteins are gradually acetylated at different lysine residues as part of the chromatin maturation process.[82] It is also thought that the old H3 and H4 proteins in the new nucleosomes recruit histone modifying enzymes that mark the new histones, contributing to epigenetic memory.

H2A and H2B

In contrast to old H3 and H4, the old H2A and H2B histone proteins are released and degraded; therefore, newly assembled H2A and H2B proteins are incorporated into new nucleosomes.[83] H2A and H2B are assembled into dimers which are then loaded onto nucleosomes by the nucleosome assembly protein-1 (NAP-1) which also assists with nucleosome sliding.[84] The nucleosomes are also spaced by ATP-dependent nucleosome-remodeling complexes containing enzymes such as Isw1 Ino80, and Chd1, and subsequently assembled into higher order structure.[85][86]


Gallery

File:Nucleosome core particle 1EQZ v.3.jpg File:Nucleosome core particle 1EQZ v.4.jpg File:Nucleosome core particle 1EQZ v.5.jpg

The crystal structure of the nucleosome core particle ([87][88]) - different views showing details of histone folding and organization. Histones , , , and are coloured.
...
Category:Molecular biology Category:Epigenetics Category:Nuclear organization

[1] McGrawhill

[2]

[3] Backstage with a command performer News Release, Rockefeller University, Feb. 18, 2003
...
[19] The structure of the nucleosome core particle at 7Å resolution, Richmond, T., Finch, J.T., Rushton, B., Rhodes, D. and Klug, A. (1984) Nature 311, 532-37
...
[29] Alberts, Bruce. Essential Cell Biology. 2nd ed. New York: Garland Science, 2009. Print.
