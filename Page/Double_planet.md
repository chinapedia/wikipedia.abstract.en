...
A definition proposed in the Astronomical Journal calls for both bodies to individually satisfy an orbit-clearing criterion in order to be called a double planet.[3]
...
The center of mass of the Jupiter–Sun system lies outside the surface of the Sun, though arguing that Jupiter and the Sun are a double star is _not_ analogous to arguing Pluto-Charon is a double dwarf planet. The problem is that Jupiter is not a star, or even a brown dwarf, and due to its low mass it is unable to achieve any form of fusion.[4]
...
where is the mass of the primary (the larger body), is the mass of the Sun, is the distance between the smaller body and the Sun, and is the distance between the smaller body and the primary.[6] The tug-of-war value does not rely on the mass of the satellite (the smaller body).
...
Category:Types of planet Category:Binary systems
...
[5] Asimov, Isaac (1975). "Just Mooning Around", collected in _Of Time and Space, and Other Things_. Avon. Formula derived on p. 89 of book. p. 55 of .pdf file. Retrieved 2012-01-20.
