Slope_Field.png of $F(x) = \frac{x^3}{3}-\frac{x^2}{2}-x+c$, showing three of the infinitely many solutions that can be produced by varying the arbitrary constant .]]
