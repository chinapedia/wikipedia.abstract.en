...
   if not(pagepointer) then return "_Module:Aside: The page " .. '"' .. page .. '"' .. " could not be accessed._" end
...
   end
           
   -- the first set of  and  puts arbitrary text at the beginning.
...
       output=output.. commentdate .." "..commentuser..": "..(mw.ustring.sub(comment, 1, length) or "").."
" -- this isn't really the output I want yet
   end
